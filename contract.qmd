...
|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| Acquiring Data Sets | Finding 3 data sets that meet project description.                                                                                         | Remi                      |
| Clean Data          | Remove/Replace NULL values. Normalize as needed. Change datatypes as needed.                                                               | Anudeep & Conner          |
| Questions           | Decide on 2 project questions.                                                                                                             | Whole Team                |
| Project Proposal    | Create a proposal including an introduction, description of data sets, glimpses of data, and our questions we seek to answer.              | Remi, Ravleen, & Anudeep  |
| Peer Review         | In-class peer review of 2 other teams.                                                                                                     | Whole Team                |
| Data Mutation       | TBD                                                                                                                                        | Anudeep, Aditya, & Conner |
| Data Visualizations | Create 4 plots based off our data analysis.                                                                                                | Ravleen & Neha            |
| Data Mutation       | TBD                                                                                                                                        | Anudeep, Aditya, & Conner |
| Data Visualizations | Create 4 plots based off our data analysis.                                                                                                | Ravleen & Neha            |
| Write up            | Create a formal write up including an introduction, description of data sets, glimpses of data, and our questions, as well as our results. | Remi, Ravleen, & Conner   |
| Presentation        | Create slides to present our findings in class.                                                                                            | Whole Team                |
| Peer Review         | Do in-group peer reviews of team members individually.                                                                                     | Whole Team                |
