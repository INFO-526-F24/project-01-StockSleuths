...
1.  Identify and select appropriate datasets to generate accurate and meaningful visualizations.

2.  Select the most suitable plots or graphs for datasets to ensure clear and effective interpretation.

3.  Create visually appealing plots that are accessible and inclusive for individuals with color vision deficiencies.

4.  Interpret relationships between geopolitical events and market performance.

5.  Analyze the war’s impact on U.S. oil prices and stock trends.

6.  Relevant data gathering and data analysis to meet the objectives
...
-   Data Analyst: Anudeep Appikatla & Connor Alubowicz – Responsible for data cleaning, analysis, and exploratory visualizations.
...
|--------------|-------------------------------|--------------|--------------|
>>>>>>> origin/main
>>>>>>> d292b565eadbd4c911c50614887748e1c11de6cf
| Acquiring Data Sets | Finding 3 data sets that meet project description.                                                                                         | Remi                      | 9-30-2024  |
| Clean Data          | Remove/Replace NULL values. Normalize as needed. Change datatypes as needed.                                                               | Anudeep & Conner          | 11-13-2024 |
| Questions           | Decide on 2 project questions.                                                                                                             | Whole Team                | 9-30-2024  |
| Project Proposal    | Create a proposal including an introduction, description of data sets, glimpses of data, and our questions we seek to answer.              | Remi, Ravleen, & Anudeep  | 10-16-2024 |
| Peer Review         | In-class peer review of 2 other teams.                                                                                                     | Whole Team                | 11-13-2024 |
<<<<<<< HEAD
| Data Mutation       | TBD                                                                                                                                        | Anudeep, Aditya, & Conner | 11-13-2024 |
| Data Visualizations | Create 4 plots based off our data analysis.                                                                                                | Ravleen & Neha            | 11-13-2024 |
=======
| Data Mutation       | TBD                                                                                                                                        | Anudeep, Aditya, & Conner | 11-30-2024 |
| Data Visualizations | Create 4 plots based off our data analysis.                                                                                                | Ravleen & Neha            | 11-30-2024 |
>>>>>>> origin/main
| Write up            | Create a formal write up including an introduction, description of data sets, glimpses of data, and our questions, as well as our results. | Remi, Ravleen, & Conner   | 12-10-2024 |
| Presentation        | Create slides to present our findings in class.                                                                                            | Whole Team                | 12-13-2024 |
| Peer Review         | Do in-group peer reviews of team members individually.                                                                                     | Whole Team                | 12-13-2024 |
