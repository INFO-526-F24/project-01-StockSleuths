...
{style="text-align: center;"} <video controls width="800"> <source src="videos/sample-video.mp4" type="video/mp4"> Your browser does not support the video tag. </video>
...
<source src="animated_time_series_q1.mp4" type="video/mp4">
